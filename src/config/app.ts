...
|
*/
export const appKey: string = 'rZ7JqKbUnCfgT-o5mx_XV95ulem9Kr-2'
...
export const binance_integration = {
  api_key: process.env.BINANCE_API_KEY,
  secret_key: process.env.BINANCE_API_SECRET_KEY,
  base_url: process.env.BINANCE_API_URL,
}
